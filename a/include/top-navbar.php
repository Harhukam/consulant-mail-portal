...
<a href="#">
<img src="images/maillogo.png" class="img-responsive" alt=""><!-- set site name here -->
</a>
</div>
</div>
<!-- end BRAND HEADING -->
...
<span class="number"><?php echo $countmails; ?></span> <i class="fa fa-caret-down"></i>
</a>
<ul class="dropdown-menu dropdown-scroll dropdown-messages">

<!-- Messages Dropdown Heading -->
<li class="dropdown-header">
<i class="fa fa-envelope"></i> You have total <?php echo $countmails; ?>  Message(s)
</li>
...
<div class="row">
<div class="col-xs-2">
<img class="img-circle" src="users/img/user-profile-1.jpg" alt="">
</div>
<div class="col-xs-10">
<p>
...
<span class="number"><?php echo $countnotify; ?></span><i class="fa fa-caret-down"></i>
</a>
<ul class="dropdown-menu dropdown-scroll dropdown-alerts">

<!-- Alerts Dropdown Heading -->
<li class="dropdown-header">
<i class="fa fa-bell"></i> <?php echo $countnotify; ?>  New Alert(s)
</li>
...
<li class="dropdown-header">
<i class="fa fa-tasks"></i> 0 Pending Tasks
</li>
...
<strong><?php echo $row['adminName']; ?></strong>
</a>
</li>
</ul>
<!-- /.dropdown-menu -->
